...
type ScrimProps = {
  ...
  exitDuration?: number;
  /**
   * Height of a UI element overlaid above this scrim with a higher z-index.
   * Adds equivalent padding so flex centering targets the visible area rather
  ...
  return (
    <div
      ...
      style={{
        ...
        background,
        padding: 16,
        paddingTop: 16 + overlayTopHeight,
