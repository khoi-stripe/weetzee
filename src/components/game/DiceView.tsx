...
function FarkleActionButton({
  ...
  useEffect(() => {
    ...
    intervalRef.current = setInterval(() => setHotIdx((i) => 1 - i), 1500);
        ...
        >
          <button
            ...
            style={{
              ...
              opacity: (enabled || bankAnim !== "idle") ? 1 : 0.35,
              fontSize: "clamp(11px, 8cqi, 100px)",
              fontWeight: WEIGHT.semibold,
              color: (enabled || bankAnim !== "idle") ? COLOR.surfaceBg : COLOR.textPrimary,
              background: (enabled || bankAnim !== "idle") ? COLOR.textPrimary : "transparent",
              cursor: enabled ? "pointer" : "default",
              lineHeight: 1.2,
              padding: "4%",
            }}
